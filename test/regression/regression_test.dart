...
void main() {
  ...
  group('Regresión - BUG-001 logout borra preferencias de onboarding', () {
    test(
      'logout preserva el flag de onboarding tras limpiar la sesión',
      () async {
        SharedPreferences.setMockInitialValues({
          'token': 'access_123',
          'user_id': 'user_001',
  ...
  group('Regresión - BUG-002 desafío estado case-sensitive', () {
    test(
      'desafío con estado en mayúsculas desde el backend es reconocido correctamente',
      () {
  ...
  group(
    'Regresión - BUG-003 PetModel muestra imagen incorrecta con 0 puntos',
    () {
      test(
        'hijo sin puntos muestra imagen base del raccu, no imagen de avatar',
        () {
  ...
  group(
    'Regresión - BUG-004 byId lanza excepción con tipo de avatar desconocido',
    () {
