...
void main() {
  ...
  group('Pruebas para RegistroScreen', () {
    testWidgets('1. Muestra el título "Crea tu cuenta"', (tester) async {
      await tester.pumpWidget(const MaterialApp(home: RegistroScreen()));
      await tester.pumpAndSettle();
      expect(find.text('Crea tu cuenta'), findsOneWidget);
    });

    testWidgets('2. Muestra el subtítulo "Únete a la familia Raccu"', (
      tester,
    ) async {
      await tester.pumpWidget(const MaterialApp(home: RegistroScreen()));
      await tester.pumpAndSettle();
    ...
    testWidgets('4. Muestra campo "Correo Electrónico"', (tester) async {
      await tester.pumpWidget(const MaterialApp(home: RegistroScreen()));
      await tester.pumpAndSettle();
      expect(find.text('Correo Electrónico'), findsOneWidget);
    });

    testWidgets('5. Muestra el botón "REGISTRARSE"', (tester) async {
      await tester.pumpWidget(const MaterialApp(home: RegistroScreen()));
      await tester.pumpAndSettle();
      expect(find.text('REGISTRARSE'), findsOneWidget);
    });

    testWidgets('6. Muestra icono arrow_back en el AppBar', (tester) async {
      await tester.pumpWidget(const MaterialApp(home: RegistroScreen()));
      await tester.pumpAndSettle();
      expect(find.byIcon(Icons.arrow_back), findsOneWidget);
    });

    testWidgets('7. Muestra los campos con iconos de candado y email', (
      tester,
    ) async {
      await tester.pumpWidget(const MaterialApp(home: RegistroScreen()));
      await tester.pumpAndSettle();
    ...
    testWidgets('8. Muestra icono del calendario en campo de fecha', (
      tester,
    ) async {
      await tester.pumpWidget(const MaterialApp(home: RegistroScreen()));
      await tester.pumpAndSettle();
  ...
  group('Pruebas de validacion', () {
    ...
    testWidgets('9. Muestra error cuando las contrasenas no coinciden', (
      tester,
    ) async {
    ...
    testWidgets(
      '10. Muestra error cuando no se selecciona la fecha de nacimiento',
      (tester) async {
        await tester.pumpWidget(wrap());
        await tester.pumpAndSettle();
        ...
        await tester.pump();
        expect(
          find.text('Por favor, ingresa tu fecha de nacimiento.'),
          findsOneWidget,
        );
      },
    );

    testWidgets('11. Error de API muestra mensaje de error en pantalla', (
      tester,
    ) async {
      ApiService.testClient = MockClient(
  ...
  group('Pruebas con fecha seleccionada', () {
    ...
    testWidgets(
      '13. Con fecha elegida y contraseñas iguales _registro() llama a la API',
      (tester) async {
        ApiService.testClient = MockClient(
          (req) async =>
        ...
        expect(
          find.text('Error al registrarse. Intenta de nuevo.'),
          findsOneWidget,
        );
      },
    );

    testWidgets('14. Error 429 muestra mensaje de límite de correos', (
      tester,
    ) async {
      ApiService.testClient = MockClient(
        (req) async => http.Response('{"detail": "429 rate limit"}', 429),
      );
      await tester.pumpWidget(const MaterialApp(home: RegistroScreen()));
      await tester.pumpAndSettle();
      final fechaOk = await seleccionarFechaEnDatePicker(tester);
    ...
    testWidgets(
      '15. Registro exitoso navega a VerificarIdentidadScreen sin error',
      (tester) async {
