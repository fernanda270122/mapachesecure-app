...
void main() {
  ...
  group('Pruebas para RecompensasScreen', () {
    testWidgets('1. Muestra el titulo Tienda de Recompensas en el AppBar', (tester) async {
    ...
    testWidgets('3. Muestra la primera recompensa Elegir la pelicula', (tester) async {
      await tester.pumpWidget(_wrap());
      await tester.pumpAndSettle();
      expect(find.text('Elegir la película'), findsOneWidget);
    });

    testWidgets('4. Muestra los puntos de la primera recompensa', (tester) async {
      await tester.pumpWidget(_wrap());
      await tester.pumpAndSettle();
      expect(find.text('150 MapachePoints'), findsOneWidget);
    });

    testWidgets('5. Todos los switches inician en estado inactivo', (tester) async {
      await tester.pumpWidget(_wrap());
      await tester.pumpAndSettle();
    ...
    testWidgets('6. Activar el switch de la primera recompensa cambia su estado', (tester) async {
      await tester.pumpWidget(_wrap());
      await tester.pumpAndSettle();
    ...
    testWidgets('7. Muestra otras recompensas de la lista', (tester) async {
      ...
      expect(find.text('Salida al parque', skipOffstage: false), findsOneWidget);
      expect(find.text('30 min extra de juegos', skipOffstage: false), findsOneWidget);
    });
  });
}
