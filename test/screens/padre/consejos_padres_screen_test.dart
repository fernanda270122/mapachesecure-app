...
void main() {
  ...
  group('Pruebas para ConsejosPadresScreen', () {
    testWidgets('1. Muestra "Consejos para Padres" en el AppBar', (
      tester,
    ) async {
    ...
    testWidgets('2. Muestra la sección de instalación', (tester) async {
      await tester.pumpWidget(_wrap());
      await tester.pumpAndSettle();
      expect(
    ...
    testWidgets('3. Al hacer scroll muestra la sección sobre desafíos', (
      tester,
    ) async {
      await tester.pumpWidget(_wrap());
      await tester.pumpAndSettle();
