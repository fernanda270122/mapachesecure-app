...
Widget _wrap() => ScreenUtilInit(
  ...
  builder: (_, __) => ChangeNotifierProvider(
    ...
    child: const MaterialApp(home: ActividadHijoScreen(hijo: _hijoTest)),
  ),
);
...
void main() {
  ...
  group('Pruebas para ActividadHijoScreen', () {
    ...
    testWidgets('2. Muestra indicador de carga en estado inicial', (
      tester,
    ) async {
      await tester.pumpWidget(_wrap());
    ...
    testWidgets('5. Muestra "Resumen de Hoy" tras cargar', (tester) async {
      await tester.pumpWidget(_wrap());
      await _pumpLoaded(tester);
      expect(find.textContaining('Resumen de Hoy'), findsOneWidget);
    });

    testWidgets('6. Muestra "Tiempo por Aplicación" en el estado cargado', (
      tester,
    ) async {
      await tester.pumpWidget(_wrap());
      await _pumpLoaded(tester);
    ...
    testWidgets('7. Muestra mensaje cuando no hay registros de actividad', (
      tester,
    ) async {
      await tester.pumpWidget(_wrap());
      await _pumpLoaded(tester);
  ...
  group('Pruebas con actividad', () {
    Future<void> cargar(
      WidgetTester tester, {
      required String actividadJson,
    }) async {
      ApiService.testClient = MockClient(
        (req) async => http.Response(actividadJson, 200),
      );
      await tester.pumpWidget(_wrap());
    ...
    testWidgets('8. Con actividad muestra Tiempo Total de Pantalla', (
      tester,
    ) async {
      await cargar(
        tester,
        actividadJson: '[{"package_name":"com.youtube","minutos_uso":45}]',
      );
    ...
    testWidgets('9. Muestra YouTube cuando hay uso de YouTube', (tester) async {
      await cargar(
        tester,
        actividadJson:
            '[{"package_name":"com.google.android.youtube","minutos_uso":30}]',
      );
      expect(find.text('YouTube'), findsOneWidget);
    });

    testWidgets('10. Muestra WhatsApp cuando hay uso de WhatsApp', (
      tester,
    ) async {
      await cargar(
        tester,
        actividadJson: '[{"package_name":"com.whatsapp","minutos_uso":20}]',
      );
      expect(find.text('WhatsApp'), findsOneWidget);
    });

    testWidgets('11. Muestra Instagram cuando hay uso de Instagram', (
      tester,
    ) async {
      await cargar(
        tester,
        actividadJson:
            '[{"package_name":"com.instagram.android","minutos_uso":25}]',
      );
    ...
    testWidgets('12. Muestra TikTok cuando hay uso de TikTok', (tester) async {
      await cargar(
        tester,
        actividadJson:
            '[{"package_name":"com.zhiliao.tiktok","minutos_uso":15}]',
      );
      expect(find.text('TikTok'), findsOneWidget);
    });

    testWidgets('13. Muestra Facebook cuando hay uso de Facebook', (
      tester,
    ) async {
      await cargar(
        tester,
        actividadJson:
            '[{"package_name":"com.facebook.katana","minutos_uso":10}]',
      );
    ...
    testWidgets('14. Muestra Chrome cuando hay uso de Chrome', (tester) async {
      await cargar(
        tester,
        actividadJson:
            '[{"package_name":"com.android.chrome","minutos_uso":12}]',
      );
      expect(find.text('Chrome'), findsOneWidget);
    });

    testWidgets('15. Muestra Discord cuando hay uso de Discord', (
      tester,
    ) async {
      await cargar(
        tester,
        actividadJson: '[{"package_name":"com.discord.app","minutos_uso":8}]',
      );
    ...
    testWidgets('16. Muestra Roblox cuando hay uso de Roblox', (tester) async {
      await cargar(
        tester,
        actividadJson:
            '[{"package_name":"com.roblox.client","minutos_uso":60}]',
      );
      expect(find.text('Roblox'), findsOneWidget);
    });

    testWidgets('17. Muestra nombre alternativo para apps desconocidas', (
      tester,
    ) async {
      await cargar(
        tester,
        actividadJson: '[{"package_name":"com.unknown.myapp","minutos_uso":5}]',
      );
      expect(find.text('MYAPP'), findsOneWidget);
    });

    testWidgets('18. Muestra tiempo en horas cuando supera 60 minutos', (
      tester,
    ) async {
      await cargar(
        tester,
        actividadJson: '[{"package_name":"com.youtube","minutos_uso":90}]',
      );
