...
void main() {
  ...
  group('Pruebas para DesafiosScreen', () {
    testWidgets('1. Muestra "Gestionar Desafíos" en el AppBar', (tester) async {
  ...
  group('Pruebas con datos', () {
    ...
    testWidgets('6. Muestra el subtitulo Toca para ver sus desafios', (
      tester,
    ) async {
      await cargar(tester);
    ...
    testWidgets('7. Muestra el texto de instruccion al cargar hijos', (
      tester,
    ) async {
      await cargar(tester);
      expect(
        find.text('Selecciona un hijo para ver sus desafíos'),
        findsOneWidget,
      );
    });

    testWidgets('8. Muestra icono de child_care en la tarjeta del hijo', (
      tester,
    ) async {
      await cargar(tester);
    ...
    testWidgets(
      '11. Error de API en _cargarHijos actualiza estado sin crash (cubre L37)',
      (tester) async {
    ...
    testWidgets(
      '12. Tap en tarjeta de hijo navega a DesafiosHijoScreen (cubre L104-109)',
      (tester) async {
        await cargar(tester);
