...
void main() {
  group('Pruebas unitarias para ReglaBloqueo (Gestión de reglas)', () {
    ...
    test(
      '2. Regla sin apps afectadas retorna lista vacía',
      () {
        final json = {
          'hora_inicio': '20:00',
          'hora_fin': '22:00',
    ...
    test(
      '3. Regla con múltiples días los parsea todos correctamente',
      () {
        final json = {
          'hora_inicio': '14:00',
          'hora_fin': '18:00',
    ...
    test(
      '4. Regla con horario de medianoche se maneja correctamente',
      () {
        final json = {
          'hora_inicio': '22:00',
          'hora_fin': '23:59',
